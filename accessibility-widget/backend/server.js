...
app.get("/widget", (req, res) => {
    res.sendFile(path.join(__dirname, '..', 'widget', 'index.js'));
});

app.get("/widget/style", (req, res) => {
    res.sendFile(path.join(__dirname, '..', 'widget', 'style.css'));
});
...
app.get("/api/check/:domain", async (req, res) => {
  try {
    ...
    const registered = await Domain.findOne({ domain });
